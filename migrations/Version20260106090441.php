 ...
 */
final class Version20260106090441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventory ADD category_id INT DEFAULT NULL, DROP category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventory ADD category VARCHAR(255) NOT NULL, DROP category_id');
    }
}
